# AI Engineering Code Demos

These demos were extracted from Finom prep and generalized as reusable AI engineering examples.
...
## 1b. Fintech MAS Architecture Study

`../resources/2026-04-20-multi-agent-system-architecture-for-fintech.md` — extracted architecture note mapping Finom's public AI Accountant signals to a bounded, auditable MAS design.

## 6b. Sync→Async Verification Pack

`python-sync-async-refactor/INTERVIEW_PACK.md` — the reusable problem framing, contract invariance rule, and talk-track anchors for the sync→async drill.

`python-sync-async-refactor/VERIFICATION.md` — exact commands, pass/fail summary, and measured sync vs async timings.
