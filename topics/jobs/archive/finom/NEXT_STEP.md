...
- `../archive/finom/insights/live-coding-with-ai-agents-advanced-patterns.md` — verbal anchors for live round
- `../archive/finom/insights/confidence-calibration-deep-dive.md` — ECE, Platt scaling, earned autonomy math
