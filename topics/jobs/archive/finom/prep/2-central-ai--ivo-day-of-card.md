...
> **MAS talking point:** "Finom's AI Accountant is a multi-agent system — I've built production systems with the same shape: typed agent boundaries, confidence propagation between stages, failure isolation, and end-to-end observability. See `../../../ai-engineering/resources/2026-04-20-multi-agent-system-architecture-for-fintech.md` for the extracted study."
