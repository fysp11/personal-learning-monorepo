...
5. **`../../archive/finom/insights/live-coding-with-ai-agents-advanced-patterns.md`** — Skim the "Three Modes" section and the "Things to Say Out Loud" table. These are your verbal anchors during the live round.

6. **`../../archive/finom/insights/confidence-calibration-deep-dive.md`** — Skim "Core Concepts" and the "Per-Market Calibration" section. Know why France needs conservative thresholds.
