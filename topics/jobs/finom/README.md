...
## Post-Interview Analysis (Apr 16)
- `insights/interview-3-retrospective.md` — post-interview retrospective: what "profile mismatch" means technically, 4 scenarios for live round, what to fix
- `insights/transferable-patterns-next-ai-role.md` — complete synthesis of vocabulary, Python impl reference, live-round operating discipline, role taxonomy
- `code/python-pipeline/pipeline.py` — canonical Python pipeline: runs out-of-box, multi-market (DE+FR), sync+async, all 4 terminal states
