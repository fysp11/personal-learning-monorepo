[Skip to main content](https://docs.langchain.com/oss/javascript/langgraph/interrupts#content-area)
...
- [Pause using interrupt](https://docs.langchain.com/oss/javascript/langgraph/interrupts#pause-using-interrupt)
- [Resuming interrupts](https://docs.langchain.com/oss/javascript/langgraph/interrupts#resuming-interrupts)
- [Common patterns](https://docs.langchain.com/oss/javascript/langgraph/interrupts#common-patterns)
- [Stream with human-in-the-loop (HITL) interrupts](https://docs.langchain.com/oss/javascript/langgraph/interrupts#stream-with-human-in-the-loop-hitl-interrupts)
- [Handling multiple interrupts](https://docs.langchain.com/oss/javascript/langgraph/interrupts#handling-multiple-interrupts)
- [Approve or reject](https://docs.langchain.com/oss/javascript/langgraph/interrupts#approve-or-reject)
- [Review and edit state](https://docs.langchain.com/oss/javascript/langgraph/interrupts#review-and-edit-state)
- [Interrupts in tools](https://docs.langchain.com/oss/javascript/langgraph/interrupts#interrupts-in-tools)
- [Validating human input](https://docs.langchain.com/oss/javascript/langgraph/interrupts#validating-human-input)
- [Rules of interrupts](https://docs.langchain.com/oss/javascript/langgraph/interrupts#rules-of-interrupts)
- [Do not wrap interrupt calls in try/catch](https://docs.langchain.com/oss/javascript/langgraph/interrupts#do-not-wrap-interrupt-calls-in-try%2Fcatch)
- [Do not reorder interrupt calls within a node](https://docs.langchain.com/oss/javascript/langgraph/interrupts#do-not-reorder-interrupt-calls-within-a-node)
- [Do not return complex values in interrupt calls](https://docs.langchain.com/oss/javascript/langgraph/interrupts#do-not-return-complex-values-in-interrupt-calls)
- [Side effects called before interrupt must be idempotent](https://docs.langchain.com/oss/javascript/langgraph/interrupts#side-effects-called-before-interrupt-must-be-idempotent)
- [Using with subgraphs called as functions](https://docs.langchain.com/oss/javascript/langgraph/interrupts#using-with-subgraphs-called-as-functions)
- [Debugging with interrupts](https://docs.langchain.com/oss/javascript/langgraph/interrupts#debugging-with-interrupts)
- [Using LangSmith Studio](https://docs.langchain.com/oss/javascript/langgraph/interrupts#using-langsmith-studio)
...
## [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#pause-using-interrupt)  Pause using `interrupt`
...
## [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#resuming-interrupts)  Resuming interrupts
...
- [Approval workflows](https://docs.langchain.com/oss/javascript/langgraph/interrupts#approve-or-reject): Pause before executing critical actions (API calls, database changes, financial transactions)
- [Handling multiple interrupts](https://docs.langchain.com/oss/javascript/langgraph/interrupts#handling-multiple-interrupts): Pair interrupt IDs with resume values when resuming multiple interrupts in a single invocation
- [Review and edit](https://docs.langchain.com/oss/javascript/langgraph/interrupts#review-and-edit-state): Let humans review and modify LLM outputs or tool calls before continuing
- [Interrupting tool calls](https://docs.langchain.com/oss/javascript/langgraph/interrupts#interrupts-in-tools): Pause before executing tool calls to review and edit the tool call before execution
- [Validating human input](https://docs.langchain.com/oss/javascript/langgraph/interrupts#validating-human-input): Pause before proceeding to the next step to validate human input

### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#stream-with-human-in-the-loop-hitl-interrupts)  Stream with human-in-the-loop (HITL) interrupts
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#handling-multiple-interrupts)  Handling multiple interrupts
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#approve-or-reject)  Approve or reject
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#review-and-edit-state)  Review and edit state
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#interrupts-in-tools)  Interrupts in tools
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#validating-human-input)  Validating human input
...
## [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#rules-of-interrupts)  Rules of interrupts
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#do-not-wrap-interrupt-calls-in-try/catch)  Do not wrap `interrupt` calls in try/catch
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#do-not-reorder-interrupt-calls-within-a-node)  Do not reorder `interrupt` calls within a node
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#do-not-return-complex-values-in-interrupt-calls)  Do not return complex values in `interrupt` calls
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#side-effects-called-before-interrupt-must-be-idempotent)  Side effects called before `interrupt` must be idempotent
...
## [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#using-with-subgraphs-called-as-functions)  Using with subgraphs called as functions
...
## [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#debugging-with-interrupts)  Debugging with interrupts
...
### [​](https://docs.langchain.com/oss/javascript/langgraph/interrupts\#using-langsmith-studio)  Using LangSmith Studio
...
[Streaming\\
\\
Previous](https://docs.langchain.com/oss/javascript/langgraph/streaming) [Use time-travel\\
\\
Next](https://docs.langchain.com/oss/javascript/langgraph/use-time-travel)
